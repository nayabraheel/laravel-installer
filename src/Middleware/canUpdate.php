...
namespace Prosigns\LaravelInstaller\Middleware;

use Closure;
use Prosigns\LaravelInstaller\Middleware\canInstall;

class canUpdate
{
    use \Prosigns\LaravelInstaller\Helpers\MigrationsHelper;
